...
public class Prefix {
	...
	public String getForClass(boolean _private, String scopeName, String className) {
		if (scopeName == null || scopeName.equals("")) {
			scopeName = className;
			return "struct_" + this.getForScope(_private, scopeName);
		}
		
		return "struct_" + this.getForScope(_private, scopeName) + className + "_";
	}
	
	public String getForClass(Token visibility, String scopeName, String className) {
		boolean _private = false;
